...
\`\`\`json
{
  "creativeDirections": [
    {
      "pointId": "SP001",
      "creativeName": "创意名称（网文风格）",
      "creativeHook": "第一秒钩子（直白刺激）",
      "tiktok": {
        "videoScript": "完整脚本（用网文语言描述画面）",
        "caption": "配文（网文爽点式，直接戳痛点）",
        "hashtags": ["#标签1","#标签2"]
      },
      "facebook": {
        "headline": "标题（一句话抓眼球）",
        "primaryText": "主文案（网文叙事风格，有代入感）"
      },
      "visualBrief": "视觉描述（用网文语言说画面）",
      "emotionalAngle": "情感切入点（直白说痛点和爽点）"
    }
  ]
}
\`\`\``;
